        ...
        <div class="table-scroll">
            <table>
                ...
                <tbody>
                    ...
                    <tr><td><div class="cell-main"><div class="thumb thumb-terracotta">{{ substr($p['name'] ?? 'P',0,1) }}</div><div><div class="cell-title" style="font-size:13px">{{ $p['name'] ?? 'Coca Cola 500ml' }}</div><div class="cell-sub">{{ $p['category'] ?? 'Beverages' }}</div></div></div></td><td class="center"><span class="cell-mono">{{ $p['sku'] ?? 'SKU-001' }}</span></td><td class="right"><span class="tag tag-blue">{{ $p['qty'] ?? 12 }}</span></td><td class="right">TZS {{ number_format($p['revenue'] ?? 12000) }}</td></tr>
                    @empty
                    <tr><td><div class="cell-main"><div class="thumb thumb-terracotta">C</div><div><div class="cell-title" style="font-size:13px">Coca Cola 500ml</div><div class="cell-sub">Beverages</div></div></div></td><td class="center"><span class="cell-mono">COCA-500</span></td><td class="right"><span class="tag tag-blue">—</span></td><td class="right">TZS —</td></tr>
                    <tr><td><div class="cell-main"><div class="thumb thumb-gold">M</div><div><div class="cell-title" style="font-size:13px">Maize Flour 1KG</div><div class="cell-sub">Groceries</div></div></div></td><td class="center"><span class="cell-mono">MAIZ-1KG</span></td><td class="right"><span class="tag tag-gold">—</span></td><td class="right">TZS —</td></tr>
                    <tr><td><div class="cell-main"><div class="thumb thumb-green">S</div><div><div class="cell-title" style="font-size:13px">Sugar 1KG</div><div class="cell-sub">Groceries</div></div></div></td><td class="center"><span class="cell-mono">SUGA-1KG</span></td><td class="right"><span class="tag tag-green">—</span></td><td class="right">TZS —</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
